...
import { Zap, BarChart3, Briefcase } from "lucide-react";
...
function ResumeCard({ resume, refreshData }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-around p-4 bg-white rounded-b-lg shadow-md gap-1 overflow-x-auto">
        <Button
          variant="ghost"
        ...
        <Button
          ...
          title="ATS Check"
        >
          <Zap className="text-gray-600 hover:text-blue-600 transition duration-300 ease-in-out" />
        </Button>
        <Button
          variant="ghost"
          onClick={() => navigate(`/dashboard/resume-analyzer/${resume._id}`)}
          className="mx-1 flex-shrink-0"
          size="sm"
          title="Analyze"
        >
          <BarChart3 className="text-gray-600 hover:text-green-600 transition duration-300 ease-in-out" />
        </Button>
        <Button
          variant="ghost"
          onClick={() => navigate(`/dashboard/job-match/${resume._id}`)}
          className="mx-1 flex-shrink-0"
          size="sm"
          title="Job Match"
        >
          <Briefcase className="text-gray-600 hover:text-orange-600 transition duration-300 ease-in-out" />
        </Button>
        <Button
          variant="ghost"
